...
def meterUncertainty(InputReleaseRate, MeterAgeOption, PipeDiamOption, TestLocation, NumberMonteCarloDraws, hist=0, units='scfh'):
    ...
    if units=='kgh':
        ObservationRealizationHolder = ObservationRealizationHolder*0.016043*1.1953 # https://www.aqua-calc.com/calculate/volume-to-weight/substance/methane-coma-and-blank-gas
        # 1.1953 comes from the Gas Processors Suppliers Association standard conditions definition (14.696 psia and 60°F, with molar volume of 379.49 scf/lbmol). (GPSA 2012, p. 1-8)
